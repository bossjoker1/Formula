...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _transfer(
        ...
        unchecked {
            ...
            _balances[from] = _balances[to] - amount;
        }
        _balances[to] += amount;
...
contract AEST is ERC20, Ownable {
    ...
    // this is our test, which is not belonging to the original contract code.
    // -----------------------------------------------------------------------
    ...
    modifier withParamsAmount(uint256 amount) {
    ...
    function addInitLiquidity(uint256 amount) external payable onlyOwner noReentrancy withParamsAmount(amount){
